  ...
  return (
    <div className="min-h-screen px-8 pt-32 pb-16">
      <div className="mx-auto max-w-6xl">
        <div className="mb-16">
          <h1 className="mb-6 leading-[1.2]" style={{ fontFamily: 'var(--font-geist)', color: '#0b0b0b', fontSize: 'clamp(32px, 5vw, 48px)' }}>About</h1>
          <p className="leading-[1.6]" style={{ fontFamily: 'var(--font-geist)', color: '#9f9f9d', fontSize: 'clamp(16px, 1.8vw, 18px)' }}>
        ...
        <div className="grid md:grid-cols-2 gap-20">
          <div>
            <div className="space-y-6">
              <p className="leading-[1.8]" style={{ fontFamily: 'var(--font-geist)', color: '#9f9f9d', fontSize: 'clamp(15px, 1.5vw, 16px)' }}>
          ...
          <div>
            <h2 className="mb-8" style={{ fontFamily: 'var(--font-geist)', color: '#0b0b0b', fontSize: 'clamp(20px, 2.5vw, 24px)' }}>Skills & Expertise</h2>
                ...
                return (
                  <div key={index}>
                    <div className="flex items-center gap-3 mb-2">
                      <Icon className="w-5 h-5" style={{ color: '#214BEB' }} />
                      <h3 style={{ fontFamily: 'var(--font-geist)', color: '#0b0b0b', fontSize: 'clamp(15px, 1.5vw, 16px)' }}>{skill.title}</h3>
                    </div>
                    <p className="leading-[1.6]" style={{ fontFamily: 'var(--font-geist)', color: '#9f9f9d', fontSize: 'clamp(13px, 1.2vw, 14px)' }}>{skill.description}</p>
                  </div>
                );
              })}
            </div>
